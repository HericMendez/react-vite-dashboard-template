...
const ToDoList = () => {
  ...
  const tasks=[
    ...
    { id: 7, text: 'Componente de tabela', completed: false },
    { id: 8, text: 'Busca na tabela', completed: false },
    ...
    { id: 12, text: 'Corrigir bug de redirecionamento em login/logout', completed: false },
